...
function the_words_scripts() {
    ...
    wp_enqueue_style('the-words-google-fonts', add_query_arg($the_words_font_query_args, "//fonts.googleapis.com/css"));
	...
	wp_enqueue_script( 'the-words-custom', get_template_directory_uri() . '/assets/js/custom.js', array('jquery'), '20151215', true );
