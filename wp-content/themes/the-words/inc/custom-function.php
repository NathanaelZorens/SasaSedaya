...
if( !function_exists('the_words_social_icon') ):
	...
	function the_words_social_icon(){
		...
		$social_link_whatsapp = get_theme_mod('social_link_whatsapp');
		$social_link_telegram = get_theme_mod('social_link_telegram');
		...
		if( $social_link_facebook || 
			...
			<div class="ta-social-icon">
				...
				<?php if( $social_link_whatsapp ){ ?>
					<a target="_blank" href="<?php echo esc_url( $social_link_whatsapp ); ?>"><i class="fab fa-whatsapp"></i></a>
				<?php } ?>

				<?php if( $social_link_telegram ){ ?>
					<a target="_blank" href="<?php echo esc_url( $social_link_telegram ); ?>"><i class="fab fa-telegram-plane"></i></a>
				<?php } ?>
